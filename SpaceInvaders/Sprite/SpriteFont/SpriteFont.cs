    ...
    public class SpriteFont : SpriteBase
    {
        ...
        override public void Render()
        {
            ...
            for (int i = 0; i < this.pMessage.Length; i++)
            {
                ...
                float glyphWidth = pGlyph.GetAzulRect().width * this.sx;
                float glyphHeight = pGlyph.GetAzulRect().height * this.sy;

                xTmp = xEnd + glyphWidth / 2;

                this.poScreenRect.Set(xTmp, yTmp, glyphWidth, glyphHeight);
