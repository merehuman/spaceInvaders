...
namespace SE456
{
    class GameObjectNodeMan : ManBase
    {
        ...
        public static void RemoveChildren(GameObject pNode)
        {
            Debug.Assert(pNode != null);

            GameObject pGameObject = pNode;
            Debug.Assert(pGameObject != null);

            GameObject pChild = (GameObject)IteratorForwardComposite.GetChild(pGameObject);
            GameObject pTmp = null;
        ...
        public static void RemoveAll()
        {
            ...
            while (!pIt.IsDone())
            {
                ...
                pIt.Next(); // Move the iterator before removal to avoid issues
                Remove(pNode);
            }
        }
